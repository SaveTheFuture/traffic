...
public class StickerNameServlet extends BaseServlet {

  private static final Logger logger = Logger.getLogger(StickerNameServlet.class.getCanonicalName());
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    entities = StickerName.getAllStickers();
