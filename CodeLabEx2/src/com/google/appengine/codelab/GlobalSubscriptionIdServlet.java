...
public class GlobalSubscriptionIdServlet extends BaseServlet {

  private static final Logger logger = Logger.getLogger(GlobalSubscriptionIdServlet.class.getCanonicalName());
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    entities = GlobalSubscriptionId.getAllIds();
