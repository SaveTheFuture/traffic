...
public class Util {
  ...
  public static void deleteEntities(Iterable<Entity> entities) {
	  for (Entity result : entities) {
	      Util.deleteFromCache(result.getKey());
		  Util.deleteEntity(result.getKey());
	  }
  }
...
public static Iterable<Entity> listEntitieswithPagination(String kind, String searchBy, String searchFor,FetchOptions fetchOptions, Integer offset) {
...
public static Iterable<Entity> listEntities(String kind, String searchBy, String searchFor, Key ancestorkey) {
    logger.log(Level.INFO, "Search entities based on search criteria");
    Query query = new Query(kind);
...
public static Iterable<Entity> listEntities(String kind, String searchBy1, String searchFor1, 
  ...
  public static String getPostId(Entity entity) {
	  String keyString = entity.getKey().toString();
	  int start = keyString.lastIndexOf('(');
	  int end = keyString.lastIndexOf(')');
	  return keyString.substring(start+1, end);
  }
  ...
  public static String writeJSON(Iterable<Entity> entities) {
	 ...
	 *          entities to return as JSON strings
	 */
public static String writeJSONDojo(Iterable<Entity> entities) {
  logger.log(Level.INFO, "creating JSON format object");
  StringBuilder sb = new StringBuilder();
  int i = 0;
  sb.append("[");
  ...
  return sb.toString();
	...
	/**
	 * List the entity in JSON format
	 * 
	 * @param entity
